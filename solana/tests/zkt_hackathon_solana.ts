...
import { ZktHackathonSolana } from "../target/types/zkt_hackathon_solana";
...
describe("ZktHackathonSolana", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .ZktHackathonSolana as Program<ZktHackathonSolana>;
  ...
  async function initAddTogetherCompDef(
    program: Program<ZktHackathonSolana>,
